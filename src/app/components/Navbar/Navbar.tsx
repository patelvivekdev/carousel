...
export default function Navbar() {
  return (
    <>
      <header className="bg-cozey-Sky-Bold hidden lg:flex text-cozey-Fog-Soft text-xs font-semibold py-2">
        <div className="mx-auto px-4 sm:px-6 lg:px-20 flex items-center justify-between">
